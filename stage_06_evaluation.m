...
% Endpoint Error (EPE)
metrics.RAFT.EPE_LK = compute_epe(flowRaftML2, flowLK2, maskResized, 0);
metrics.RAFT_300.EPE_LK = compute_epe(flowRaftPy_300, flowLK2, maskResized, 0);
metrics.RAFT_600.EPE_LK  = compute_epe(flowRaftPy_600, flowLK2, maskResized, 0);
metrics.RAFT_900.EPE_LK  = compute_epe(flowRaftPy_900, flowLK2, maskResized, 0);
metrics.RAFT_2000.EPE_LK  = compute_epe(flowRaftPy_2000, flowLK2, maskResized, 0);

metrics.RAFT.EPE_FB = compute_epe(flowRaftML2, flowFB2, maskResized, 0);
metrics.RAFT_300.EPE_FB = compute_epe(flowRaftPy_300, flowFB2, maskResized, 0);
metrics.RAFT_600.EPE_FB = compute_epe(flowRaftPy_600, flowFB2, maskResized, 0);
metrics.RAFT_900.EPE_FB = compute_epe(flowRaftPy_900, flowFB2, maskResized, 0);
metrics.RAFT_2000.EPE_FB = compute_epe(flowRaftPy_2000, flowFB2, maskResized, 0);

% Angular Error (AE)
metrics.RAFT.AE_LK  = compute_ae(flowRaftML2, flowLK2, maskResized, 0);
metrics.RAFT_300.AE_LK  = compute_ae(flowRaftPy_300, flowLK2, maskResized, 0);
metrics.RAFT_600.AE_LK  = compute_ae(flowRaftPy_600, flowLK2, maskResized, 0);
metrics.RAFT_900.AE_LK  = compute_ae(flowRaftPy_900, flowLK2, maskResized, 0);
metrics.RAFT_2000.AE_LK  = compute_ae(flowRaftPy_2000, flowLK2, maskResized, 0);

metrics.RAFT.AE_FB  = compute_ae(flowRaftML2, flowFB2, maskResized, 0);
metrics.RAFT_300.AE_FB  = compute_ae(flowRaftPy_300, flowFB2, maskResized, 0);
metrics.RAFT_600.AE_FB  = compute_ae(flowRaftPy_600, flowFB2, maskResized, 0);
metrics.RAFT_900.AE_FB  = compute_ae(flowRaftPy_900, flowFB2, maskResized, 0);
metrics.RAFT_2000.AE_FB  = compute_ae(flowRaftPy_2000, flowFB2, maskResized, 0);

% Coverage-
[metrics.LK.coverage, validFlow_LK]   = compute_coverage(flowLK2,  maskResized, 0);
[metrics.FB.coverage, validFlow_FB]   = compute_coverage(flowFB2,  maskResized, 0);
[metrics.RAFT.coverage, validFlow_ML] = compute_coverage(flowRaftML2, maskResized, 0);
[metrics.RAFT_300.coverage, validFlow_300] = compute_coverage(flowRaftPy_300, maskResized, 0);
[metrics.RAFT_600.coverage, validFlow_600] = compute_coverage(flowRaftPy_600, maskResized, 0);
[metrics.RAFT_900.coverage, validFlow_900] = compute_coverage(flowRaftPy_900, maskResized, 0);
[metrics.RAFT_2000.coverage, validFlow_2000] = compute_coverage(flowRaftPy_2000, maskResized, 0);
...
fprintf('| Method         | EPE   | AE     | Coverage    | Runtime (s) |\n');
fprintf('|----------------|-------|--------|-------------|-------------|\n');
fprintf('| LK & FB        |-------|--------|%.1f%% %.1f%%| %.3f  %.3f |\n', ...
     metrics.LK.coverage*100,  metrics.FB.coverage*100, metrics.LK.runtime, metrics.FB.runtime);
fprintf('| RAFT300 vs LK  | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_300.EPE_LK, metrics.RAFT_300.AE_LK, metrics.RAFT_300.coverage*100, metrics.RAFT_300.runtime);
fprintf('| RAFT600 vs LK  | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_600.EPE_LK, metrics.RAFT_600.AE_LK, metrics.RAFT_600.coverage*100, metrics.RAFT_300.runtime);
fprintf('| RAFT900 vs LK  | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_900.EPE_LK, metrics.RAFT_900.AE_LK, metrics.RAFT_900.coverage*100, metrics.RAFT_300.runtime);
fprintf('| RAFT1400 vs LK | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_2000.EPE_LK, metrics.RAFT_2000.AE_LK, metrics.RAFT_2000.coverage*100, metrics.RAFT_300.runtime);
fprintf('| RAFT vs LK     | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT.EPE_LK, metrics.RAFT.AE_LK, metrics.RAFT.coverage*100, metrics.RAFT.runtime);
fprintf('| RAFT300 vs FB  | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_300.EPE_FB, metrics.RAFT_300.AE_FB, metrics.RAFT_300.coverage*100, metrics.RAFT_300.runtime);
fprintf('| RAFT600 vs FB  | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_600.EPE_FB, metrics.RAFT_600.AE_FB, metrics.RAFT_600.coverage*100, metrics.RAFT_600.runtime);
fprintf('| RAFT900 vs FB  | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_900.EPE_FB, metrics.RAFT_900.AE_FB, metrics.RAFT_900.coverage*100, metrics.RAFT_900.runtime);
fprintf('| RAFT1400 vs FB | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT_2000.EPE_FB, metrics.RAFT_2000.AE_FB, metrics.RAFT_2000.coverage*100, metrics.RAFT_2000.runtime);
fprintf('| RAFT vs FB     | %.3f | %.3f |  %.1f%%   |    %.3f     |\n', ...
    metrics.RAFT.EPE_FB, metrics.RAFT.AE_FB,  metrics.RAFT.coverage*100, metrics.RAFT.runtime);
