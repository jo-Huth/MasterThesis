...
An established alternative for long-term forecasting is nowcasting using all-sky imagers (ASIs) \cite{chow2011,kleissl2013}. These instruments capture a hemispheric view of the sky at intervals of less than a minute, providing high-resolution observations of cloud formation, deformation, and movement. While ASIs are well-suited for this purpose, extracting accurate cloud motion vectors (CMVs) from the imagery remains a challenge. Over time, various methods have been developed, with optical flow (OF) techniques proving to be among the most reliable \cite{urquhart2015}.
